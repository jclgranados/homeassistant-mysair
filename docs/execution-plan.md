...
- E6: evaluar migrar a `paho-mqtt` sobre WebSocket con SigV4, reduciendo código artesanal (se quitó de `requirements` en A4 por no usarse; habría que reintroducirlo si se retoma).
- B4 (P3): tests de robustez MQTT (reconexión, mensajes duplicados/fuera de orden, frames partidos) — ver `docs/testing-strategy.md` §P2/P3 y `CLAUDE.md §11`.
